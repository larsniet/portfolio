...
summary: "How I built a custom data visualization platform at Adhese during my internship, replacing Google Data Studio with a faster, more capable reporting environment built on Cube.js."
featured: false
---
