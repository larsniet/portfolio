    ...
    <section className="pt-2 pb-16">
      ...
      <div className="fade-up fade-up-2 mb-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-neutral-400 dark:text-neutral-500 font-[family-name:var(--font-geist-mono)]">
      ...
      <div className="flex flex-col border-t border-neutral-100 dark:border-neutral-900">
        {contacts.map((contact, i) => (
          ...
          >
            <div>
              <p className="text-xs font-medium tracking-widest uppercase text-neutral-400 dark:text-neutral-500 font-[family-name:var(--font-geist-mono)] mb-0.5">
                {contact.label}
              </p>
